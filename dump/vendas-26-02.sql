...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/02/2025 às 15:58
...
INSERT INTO `produtos` (`id`, `nome`, `descricao`, `preco`, `qtde`, `fabricante_id`) VALUES
(1, 'Ultrabook', 'Equipamento de última geração...', 3999.45, 7, 2),
(2, 'Tablet Android', 'Tablet com a versão do sistema operacional Android, possui tela de 10 polegadas e armazenamento de 128GB....', 900.00, 10, 5),
(3, 'Geladeira', 'Refrigerador frsot-free com acesso à internet', 5000.00, 12, 6),
(5, 'iPad Mini', 'Tablet Apple com tela retina display e blablabla e mó bunitinha', 4999.12, 5, 3),
